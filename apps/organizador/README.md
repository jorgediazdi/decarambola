...
## Hubs que enlazan aquí

- `club/index.html` → sección ORGANIZADOR (TORNEOS)
- `index.html` (raíz) → pestaña Organizador
- `apps/index.html` → mapa técnico

Ver `docs/ROADMAP_APPS.md`.
